...
public class StaggeredRecyclerViewAdapter extends RecyclerView.Adapter<StaggeredRecyclerViewAdapter.ViewHolder> {
    ...
    public StaggeredRecyclerViewAdapter(Context context, ArrayList<String> names, ArrayList<String> imageUrls,
                                        ArrayList<String> Article,ArrayList<String> Link) {
        mNames = names;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.article.setText(mArticle.get(position));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ImageView image;
        TextView name, article;

        public ViewHolder(View itemView) {
            super(itemView);
            this.image = itemView.findViewById(R.id.imageview_widget);
            this.name = itemView.findViewById(R.id.name_widget);
            this.article = itemView.findViewById(R.id.article);
        }
    }
}
